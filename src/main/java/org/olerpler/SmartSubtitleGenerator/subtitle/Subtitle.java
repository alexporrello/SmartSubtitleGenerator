...
public class Subtitle implements Serializable, Comparable<Subtitle> {
	 ...
	 */
	public Subtitle(Double key, int number, SubtitleTime time, String text, String contributor, SubtitleState state) {
		this.key         = key;
	 ...
	 */
	public Subtitle(String sinString) {
	...
	public void parseSinString(String sinString) {
		if(sinString.startsWith("<sin>") && sinString.endsWith("</sin>")) {			
			...
			this.state = SubtitleState.returnProperEnum(
	 ...
	 */
	public Boolean update(Subtitle s) {
